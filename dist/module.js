...
function (_super) {
  ...
  ButtonPanel.prototype.render = function () {
    ...
    var exeucte = function exeucte() {
      ...
      var url = new URL(interpolateVariables(options.url));
    ...
    var buttonText = function buttonText() {
      return interpolateVariables(_this.props.options.text);
    };

    var interpolateVariables = function interpolateVariables(text) {
      var _a;

      return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(text, (_a = _this.props.data.request) === null || _a === void 0 ? void 0 : _a.scopedVars);
    };
